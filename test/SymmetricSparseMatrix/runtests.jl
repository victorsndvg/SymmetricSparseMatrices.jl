...
@testset "SymmetricSparseMatrix" begin
    @test size(SymmetricSparseMatrices.SymmetricSparseMatrix(0,0,[1],Vector{Int}(),Vector{Int}())) == (0,0)
    @test nnz(SymmetricSparseMatrices.SymmetricSparseMatrix(0,0,[1],Vector{Int}(),Vector{Int}())) == 0
    @test getindex(SymmetricSparseMatrices.SymmetricSparseMatrix(1,1,[1,2],[1],[1]),1,1) == 1
    @test nnz(SymmetricSparseMatrices.SymmetricSparseMatrix(1,1,[1,2],[1],[1]),1,1) == 1
